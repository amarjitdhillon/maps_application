...
public class DirectionFinder {
    ...
    private static final  String googleApiKey = "AIzaSyCa7_p2TdLspIbLk2EM7kL-d40jy8sU9OE";
...
private String downloadUrl() throws UnsupportedEncodingException {
 ...
 String urlDestination = URLEncoder.encode(destinaiton, "utf-8");
    String completeURL = null;
    completeURL = DirectionUrlApi + "origin=" + urlOrigin + "destination=" + urlDestination + "&key=" + googleApiKey;
    return completeURL;
}//createurl
